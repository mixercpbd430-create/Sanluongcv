	...
	<body class="body-background">
		<div class="background panel-wrap">		
			<div class="panel">
				...
				<div class="content">
					<h1 class="header" testid="deny-message">The requested web page cannot be provided.<br><br>Address: <a href="https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/dist/html2canvas.min.js">https://cdn.jsdelivr.net/npm/html2can...</a>.<br><br>The web page has been blocked by the CP-Blocked-Web-2025 rule.<br><br>Reason: the web resource belongs to the Undetermined content category(-ies) and the Undetermined data type category(-ies).<br><br>This web resource is prohibited at the company. If you consider the blocking to be mistaken or if you need to access this web resource, contact the administrator of the local corporate network at <a href="https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/dist/html2canvas.min.js?DAF8FB8D-086B-46F7-B98E-D4F866E1BFDE_kes_cup_C6FA3ED5_6D17_47D1_B6E2_F4B02CC905E0_">Request access</a>.<br>	</h1>
					<p testid="timestamp">Message generated: 16/03/2026 5:04:24 CH</p>
				</div>
			</div>
		</div>
	</body>
